...
SETTINGS: dict = {
    ...
    "ray_node_ip": {"scope": "node", "type": "str", "help": "this node's Ray control IP"},
    ...
    "nccl_socket_ifname": {"scope": "node", "type": "csv", "help": "NIC list, local-first"},
    "gloo_socket_ifname": {"scope": "node", "type": "iface", "help": "single local NIC"},
